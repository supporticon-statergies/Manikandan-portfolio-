// ============================================================
//  SITE CONFIGURATION — Update all values here to customize
// ============================================================
    ...
    items: [
      {
        id: 1,
        title: 'AI L1 Support',
        description: 'Handles customer support queries effectively and instantly using human-like AI designed for L1 support operations.',
      },
      {
        id: 2,
        title: 'Founder Notifications',
        description: 'Real-time alerts to the Founder highlighting customer complaints, product difficulties, and feature expectations.',
      },
      {
        id: 3,
        title: 'Strategic Insights',
        description: 'Brings data-driven insights from support tickets to make better, smarter product decisions.',
      },
    ],
  },
